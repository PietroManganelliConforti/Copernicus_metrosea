...
run_mains()
{
python3 main.py --batch_size 32 --batch_size_test 256 --loss_alpha 0.02 --ema_alpha 0.9 --lr 1e-4 --num_epochs 50 --augmentations 4 --test_name baseline_31/5/24
    
python3 main.py --batch_size 32 --batch_size_test 256 --loss_alpha 0.0 --ema_alpha 0. --lr 1e-4 --num_epochs 50 --augmentations 0 --test_name baseline
...
python3 main.py --batch_size 32 --batch_size_test 256 --loss_alpha 0.02 --ema_alpha 0.0 --lr 1e-4 --num_epochs 50 --augmentations 0 --test_name test_loss_alpha_0.02
...
# #python3 main.py --batch_size 64 --batch_size_test 256 --loss_alpha 0.0 --ema_alpha 0.0 --lr 1e-3 --num_epochs 50 --small_net_flag True --augmentations 0 --test_name small_net