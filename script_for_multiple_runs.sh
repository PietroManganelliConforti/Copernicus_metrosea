...
python3 main.py --batch_size 32 --batch_size_test 256 --alpha 0.0 --lr 1e-5 --num_epochs 50 --augmentations 0 --test_name lr_1e-5

python3 main.py --batch_size 32 --batch_size_test 256 --alpha 0.2 --lr 1e-4 --num_epochs 50 --augmentations 0 --test_name test_loss_alpha_0.2
